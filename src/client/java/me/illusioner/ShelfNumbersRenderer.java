...
public class ShelfNumbersRenderer extends ShelfRenderer {
    ...
    @Override
    public void extractRenderState(ShelfBlockEntity shelfBlockEntity, ShelfRenderState shelfRenderState, float f, Vec3 vec3, ModelFeatureRenderer.@Nullable CrumblingOverlay crumblingOverlay) {
